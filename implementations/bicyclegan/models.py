...
class UNetDown(nn.Module):
    def __init__(self, in_size, out_size, normalize=True):
        """
        Downsampling layer for U-Net with optional batch normalization.
        """
...
class UNetUp(nn.Module):
    def __init__(self, in_size, out_size):
        """
        Upsampling layer for U-Net with skip connections.
        """
...
class Encoder(nn.Module):
    def __init__(self, latent_dim, input_shape):
        """
        Encoder using a modified ResNet18 architecture.
        """
...
class MultiDiscriminator(nn.Module):
    def __init__(self, input_shape):
        ...
        self.downsample = nn.AvgPool2d(kernel_size=2, stride=2, padding=1)
